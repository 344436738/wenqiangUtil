...
//	        					+ "\" -o " + swfFile + " -s languagedir=D:\\xpdf-chinese-simplified -T 9 -f";
   ...
   public static void main(String[] args) {
       //转换器安装路径
        String exePath = "D:/尚学堂架构师/开发/文件操作/文件转换/SWFTools/pdf2swf.exe";
        new SWFToolsSWFConverter().convert2SWF("E:/学习资料/spring安全框架教程（购买）/SpringSecurity3 张卫滨(译).pdf", exePath);
   }
